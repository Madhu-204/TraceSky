...
export const ForecastCard: React.FC<ForecastCardProps> = ({ days }) => {
  return (
    <div className="bg-[#111827] border border-gray-800/80 p-6 rounded-2xl">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="text-[11px] text-blue-400 font-bold hover:underline transition-all uppercase tracking-wider">
          Detailed View &gt;
        </button>
      </div>
          ...
          return (
            <div
              ...
              className={`p-4 rounded-xl border flex flex-col items-center justify-between gap-4 transition-all duration-200 ${
                isToday
                  ? 'bg-blue-600/10 border-blue-500/40 shadow-[0_0_15px_rgba(59,130,246,0.05)] relative'
