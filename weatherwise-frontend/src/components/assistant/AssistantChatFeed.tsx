          ...
          >
            ...
            <div className="space-y-2.5 flex-1 max-w-[calc(100%-3rem)]">
              ...
              <div className={`p-4 rounded-2xl text-xs leading-relaxed font-medium transition-all ${
                ...
                {/* Basic pseudo markdown parser to bold bracketed data elements safely */}
              ...
              {/* DYNAMIC RISK EMBEDDED METRICS COMPONENT */}
              {isAI && msg.hasMetricsCard && msg.metricsData && (
                <div className="bg-[#0A0D1F] border border-[#1B2244] rounded-2xl p-4 space-y-4 shadow-xl">
                  ...
                  {/* Quantitative Metric Columns Row */}
                  ...
                  {/* Micro-Histogram Spline Array Workspace */}
                  ...
                  {/* Analytical Breakdown Footer Text */}
